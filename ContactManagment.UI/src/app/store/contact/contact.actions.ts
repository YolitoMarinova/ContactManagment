...
export const loadSingleContact = createAction('[Contact] Load Single Contact', props<{ id: string }>());
export const loadSingleContactSuccess = createAction('[Contact] Load Single Contact Success', props<{ contact: Contact }>());
export const loadSingleContactFailure = createAction('[Contact] Load Single Contact Failure', props<{ error: string }>());
...
export const addContactFailure = createAction('[Contact] Add Contact Failure', props<{ error: string }>());

export const updateContact = createAction('[Contact] Update Contact', props<{ contact: Partial<Contact> }>());
export const updateContactSuccess = createAction('[Contact] Update Contact Success', props < { contact: Partial<Contact> }>());
...
export const deleteContactSuccess = createAction('[Contact] Delete Contact Success', props<{ id: string }>());
